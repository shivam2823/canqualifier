...
class ContractorTempclientsController extends AppController
{
    ...
    {
        $contractorTempclient = $this->ContractorTempclients->get($id, contain: ['Contractors', 'Sites', 'Clients']);
    ...
    {
        $contractorTempclient = $this->ContractorTempclients->get($id, contain: []);
