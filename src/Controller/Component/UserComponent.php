...
class UserComponent extends Component {
	...
	{
		$this->controller = $this->_registry->getController();
		$this->Contractors = \Cake\ORM\TableRegistry::getTableLocator()->get('Contractors');
		$this->Users = \Cake\ORM\TableRegistry::getTableLocator()->get('Users');
		$activeUser = $this->controller->getRequest()->getSession()->read('Auth.User');
		...
		if(isset($activeUser['role_id'])) {
			...
			elseif($activeUser['role_id'] == EMPLOYEE) {			
				$this->Employees = \Cake\ORM\TableRegistry::getTableLocator()->get('Employees');
    ...
    {
        $this->ContractorClients = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorClients');
    ...
    {
        $this->ContractorSites = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorSites');
        $this->Clients = \Cake\ORM\TableRegistry::getTableLocator()->get('Clients');
        $locationReq = array();
        $clients = array();
    ...
    public function getClientUserSites()
    {
        $this->controller = $this->_registry->getController();
        $activeUser = $this->controller->getRequest()->getSession()->read('Auth.User');
        $this->ClientUsers = \Cake\ORM\TableRegistry::getTableLocator()->get('ClientUsers');
	...
	{
        $this->EmployeeContractors = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeContractors');
	...
	public function getContractorServices($contractor_id=null, $allSites=false) {
		$this->Services = \Cake\ORM\TableRegistry::getTableLocator()->get('Services');
		$this->Products = \Cake\ORM\TableRegistry::getTableLocator()->get('Products');
		$this->ContractorServices = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorServices');
        $this->ClientServices = \Cake\ORM\TableRegistry::getTableLocator()->get('ClientServices');
        $this->ContractorClients = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorClients');
	...
	public function calCanqDiscount($services= array(),$contractor_id=null){
		$this->PaymentDiscounts = \Cake\ORM\TableRegistry::getTableLocator()->get('PaymentDiscounts');
	...
	public function getContractorSitesForEmp($contractor_id=null,$employee_id=null,$emp_contractors=null) {
		$this->ClientServices = \Cake\ORM\TableRegistry::getTableLocator()->get('ClientServices');
		$this->EmployeeSites = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeSites');
		if(!empty($contractor_id)){
	...
	{
		$this->controller = $this->_registry->getController();
		$this->WaitingOnLogs = \Cake\ORM\TableRegistry::getTableLocator()->get('WaitingOnLogs');
	...
	public function update_contractor_ans($requestData=array(), $contractor_id=null, $user_id=null) {
		...
		$this->Questions = \Cake\ORM\TableRegistry::getTableLocator()->get('Questions');
		$this->Contractors = \Cake\ORM\TableRegistry::getTableLocator()->get('Contractors');
   ...
   /*public function getEmpExp($contractor_id=null)
	...
	{ 
		$this->Employees = \Cake\ORM\TableRegistry::getTableLocator()->get('Employees');
		$this->EmployeeExplanations = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeExplanations');
    ...
    {       
    	$this->ContractorClients = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorClients');
    	$this->Payments = \Cake\ORM\TableRegistry::getTableLocator()->get('Payments');       
    	$this->Contractors = \Cake\ORM\TableRegistry::getTableLocator()->get('Contractors');   
    	$this->Users = \Cake\ORM\TableRegistry::getTableLocator()->get('Users');  
    	$this->controller = $this->_registry->getController();
    ...
    $this->ContractorServices = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorServices'); 
    $this->PaymentDetails = \Cake\ORM\TableRegistry::getTableLocator()->get('PaymentDetails'); 
