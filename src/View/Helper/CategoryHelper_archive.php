...
class CategoryHelper extends Helper
{
    ...
    public function getParentcat($contractor_id=null, $service_id=null, $parent_id=null, $archive=null)
    {		
	...
	$parentcatall = $this->getParentcat($contractor_id, $service_id, null, $archive);
	$allCat = array();
	...
	$childrens = $this->getParentcat($contractor_id, $service_id, $parentcat['id'], $archive);	
	foreach($childrens as $val) {
