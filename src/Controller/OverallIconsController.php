...
class OverallIconsController extends AppController
{
    ...
    {
        $overallIcon = $this->OverallIcons->get($id, contain: ['Clients', 'Contractors', 'Icons','BenchmarkCategories']);
    ...
    /*public function delete($id = null)
    {
      ...
      public function edit($id=null)
        ...
        $overallIcon = $this->OverallIcons->get($id, contain: ['Icons']);
    ...
    {
      $this->viewBuilder()->setLayout('ajax');
       $overallIcon = $this->OverallIcons->get($id, contain: []);
        $this->set('overallIcon', $overallIcon);
    }
