...
class UserHelper extends Helper
{
    ...
    public function getHuntonPercentage($contractor_id = ''){
        $this->ContractorSites = TableRegistry::get('ContractorSites');
        $this->Sites = TableRegistry::get('Sites');
        $this->SiteContacts = TableRegistry::get('SiteContacts');
        ...
        if(!empty($contractor_id)){
            ...
            $percentage = 0;
            if($existingSiteContacts > 0 && $ConHuntonSites > 0){
                $percentage = (count($existingSiteContacts)*100)/count($ConHuntonSites);
            }
            return $percentage;
        }
    }
