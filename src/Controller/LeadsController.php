...
*/  
    ...
    //$aColumn= array();s = array('Users.id', 'Users.username', 'company_name', 'pri_contact', 'Roles.role_title', 'Users.active');
        ...
        if(isset($_GET['draw'])) { 
          ...
          //  print_r($client_id);die;
            ...
            $totalCount = $this->request->getAttribute('paging')['Leads']['count'];
    ...
    {
        $lead = $this->Leads->get($id, contain: ['Clients','LeadStatus','LeadNotes','LeadNotes.CustomerRepresentative']);

		if($this->User->isClient()){
		$lead = $this->Leads->get($id, contain: ['Clients','LeadStatus','LeadNotes'=>['conditions'=>['show_to_client'=>1]],'LeadNotes.CustomerRepresentative']);
    ...
    public function edit($id = null)
    {
        ...
        $lead = $this->Leads->get($id, contain: ['LeadStatus']);
