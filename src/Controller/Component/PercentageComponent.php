...
class PercentageComponent extends Component {
    ...
    $this->Categories = \Cake\ORM\TableRegistry::getTableLocator()->get('Categories');    
    $this->PercentageDetails = \Cake\ORM\TableRegistry::getTableLocator()->get('PercentageDetails');
  ...
  public function calPercentage($category_id=null,$contractor_id=null,$client_ids=array(),$year =null)
  {
	...
	{ 
        ...
        $client_id == $tbl_percentage->client_id; 
            ...
            $PercentageDetail = \Cake\ORM\TableRegistry::getTableLocator()->get('PercentageDetails');
