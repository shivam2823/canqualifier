 ...
 * @property int|null $suggested_overall_icon_id
 * @property int|null $icon_from
 *
 * @property \App\Model\Entity\Client $client
 * @property \App\Model\Entity\Contractor $contractor
 * @property \App\Model\Entity\SuggestedOverallIcon $suggested_overall_icon
 */
class SuggestedIcon extends Entity
{
    ...
    protected $_accessible = [
        ...
        'suggested_overall_icon_id' => true,
        'icon_from' => true,
        'client' => true,
        'contractor' => true,
        'suggested_overall_icon' => true,
