...
class ClientUsersController extends AppController
{
    ...
    public function addClient($step = 1,$id = null,$client_id=null)
    {
        ...
        $clientUser = $this->ClientUsers->get($id, contain: ['Users','Clients', 'Clients.ClientServices', 'Clients.ClientServices.Services', 'Clients.ClientQuestions.Questions', 'Clients.ClientModules', 'Clients.ClientModules.Modules']);
   ...
   public function clientList()
   {
    ...
    {
        $clientUser = $this->ClientUsers->get($id, contain: ['Users', 'Clients']);
