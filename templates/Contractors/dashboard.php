                            ...
                            <ul class="open_tasks nav navbar-nav">
                                ...
                                foreach ($services as $service_id => $service_name) {
                                    ...
                                    if(!empty($categories)) {
                                        ...
                                        if($final_submit){
                                        if($service_id == 1 && isset($huntonPercentage) && $huntonPercentage >= 0 && $huntonPercentage < 100){
                                                echo '<li class="menu-item-has-children dropdown">';
                                                    echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'. $service_name .'</a>';
                                                    echo '<ul class="sub-menu children dropdown-menu">';
                                                        echo '<li>'.$this->Html->link('Complete Pre-Qualification Form', ['controller'=>'ContractorSites', 'action'=>'addContact',$activeUser['contractor_id'],$activeUser['contractor_id']], ['escape'=>false, 'title'=>'Complete Pre-Qualification Form']).'</li>';
                                                    echo '</ul>';
                                                    echo '</li>';
                                                $openTask = true;
                                        ...
                                        <li class="menu-item-has-children dropdown">
                                            ...
                                            if($service_id==1 && !empty($categories)) { //'DocuQUAL'
                                                ...
                                                /*hunton group location contact open task*/
                                                if((isset($huntonPercentage) && $huntonPercentage >= 0 && $huntonPercentage < 100)){
                                                    echo '<ul class="sub-menu children dropdown-menu">';
                                                    echo '<li>'.$this->Html->link('Complete Pre-Qualification Form', ['controller'=>'ContractorSites', 'action'=>'addContact',$activeUser['contractor_id'],$activeUser['contractor_id']], ['escape'=>false, 'title'=>'Complete Pre-Qualification Form']).'</li>';
                                                    echo '</ul>';
                                                    $openTask = true;
