...
class BenchmarkComponent extends Component {
	...
	//public array $components = ['Category', 'Safetyreport'];
	...
	{
		$this->IndustryAverages = \Cake\ORM\TableRegistry::getTableLocator()->get('IndustryAverages');
	...
	public function getIcons($contractor_id=null, $client_id=null)
	{
		...
		$this->ContractorAnswers = \Cake\ORM\TableRegistry::getTableLocator()->get('ContractorAnswers');
		$this->Benchmarks = \Cake\ORM\TableRegistry::getTableLocator()->get('Benchmarks');
