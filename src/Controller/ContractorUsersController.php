...
class ContractorUsersController extends AppController
{
    ...
    public function view($id = null,$service_id=null, $cat_id=null)
    {
        ...
        $contractorUser = $this->ContractorUsers->get($id, contain: ['Users', 'Contractors']);
    ...
    {		
		...
		if($service_id==null && $cat_id==null){
			...
			$cat_id = 0;}*/
        if($id!=null) {
        $contractorUser = $this->ContractorUsers->get($id, contain: ['Users']);
        }
        else {
	...
	public function myProfile()
    {
        ...
        $contractorUsers = $this->ContractorUsers->get($id, contain: ['Users']);
