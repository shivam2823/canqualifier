...
class EmployeeCategoryHelper extends Helper
{
    public array $helpers = ['User'];

    public function getParentcat($parent_id=null,$contractor_id=null)
    {
	$this->EmployeeCategories = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeCategories');
	$this->ClientEmployeeQuestions = \Cake\ORM\TableRegistry::getTableLocator()->get('ClientEmployeeQuestions');
 ...
 //        ->where(['contractor_id'=>$contractor_id])->enableHydration(false)->toArray();
    ...
    {
	$this->ClientEmployeeQuestions = \Cake\ORM\TableRegistry::getTableLocator()->get('ClientEmployeeQuestions');
    $this->EmployeeAnswers = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeAnswers');
    $this->EmployeeCategories = \Cake\ORM\TableRegistry::getTableLocator()->get('EmployeeCategories');
